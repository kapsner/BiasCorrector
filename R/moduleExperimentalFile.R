...
#' @title moduleExperimentalFileServer
#'
...
moduleExperimentalFileServer <- function(input, output, session, rv){
  ...
  observeEvent({
    if (!is.null(rv$fileimportExp)) TRUE
      ...
      PCRBiasCorrection::writeLog_("(app) Entered observeEvent after fileimport of experimental file", logfilename)
...
#' @title moduleExperimentalFileUI
#'
#' @param id A character. The identifier of the shiny object
#'
#' @export
#'
# moduleExperimentalFileUI
